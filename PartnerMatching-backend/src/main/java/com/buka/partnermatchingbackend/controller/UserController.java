...
import com.buka.partnermatchingbackend.contant.UserConstant;
...
import com.buka.partnermatchingbackend.model.domain.request.UserLoginRequest;
import com.buka.partnermatchingbackend.model.domain.request.UserRegisterRequest;
...
public class UserController {
    ...
    public BaseResponse<Page<User>> recommendUsers(long pageSize, long pageNum, HttpServletRequest request) {
        ...
        String redisKey = String.format("sponge:user:recommend:%s", loginUser.getId());
